# IT KMITL Clubs and Events (Backend)
...
[Asset Application](_readme/api/asset.md)

[Category Application](_readme/api/category.md)

[Community Application](_readme/api/community.md)

[Membership Application](_readme/api/membership.md)

[User Application](_readme/api/user.md)

## Design Guide
Documentation on designing guides can be viewed in each markdown file below.

[Index](_readme/guide/index.md)

[Profile Page](_readme/guide/profile-page.md)

[Community Page](_readme/guide/community-page.md)

[Invitations Bar](_readme/guide/invitations-bar.md)
